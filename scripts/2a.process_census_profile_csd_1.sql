DROP TABLE IF EXISTS census_profile.census_profile_csd_sorted;
CREATE TABLE census_profile.census_profile_csd_sorted AS
(
SELECT 
zzz."CSDUID" AS "csduid",
a.csdname,
a."DGUID",
"1_tot",
"1_m",
...
LEFT JOIN boundaries."Geometry_CSDUID" zzz on a."DGUID" = zzz."DGUID"
);
