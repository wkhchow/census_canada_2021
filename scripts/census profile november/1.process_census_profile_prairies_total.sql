...
-- prairies nov total part 1 up to 1499 columns
DROP TABLE IF EXISTS census_profile.census_profile_nov_prairies_total_temp;
CREATE TABLE census_profile.census_profile_nov_prairies_total_temp AS
(
SELECT * 
FROM CROSSTAB('SELECT "DGUID","CHARACTERISTIC_ID","C1_COUNT_TOTAL" FROM census_profile.census_profile_nov_prairies 
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_prairies_total;
CREATE TABLE census_profile.census_profile_nov_prairies_total AS
(
SELECT
b."DAUID",
a.*,
b.geom
FROM census_profile.census_profile_nov_prairies_total_temp a
...
-- prairies nov total part 2 1500 to 2631 coluns
DROP TABLE IF EXISTS census_profile.census_profile_nov_prairies_total_temp;
CREATE TABLE census_profile.census_profile_nov_prairies_total_temp AS
(
SELECT * 
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_prairies_total2;
CREATE TABLE census_profile.census_profile_nov_prairies_total2 AS
(
SELECT
b."DAUID",
a.*,
...
-- create indexes
CREATE INDEX IF NOT EXISTS census_profile_nov_prairies_total_idx ON census_profile.census_profile_nov_prairies_total using GIST(geom);
CREATE INDEX IF NOT EXISTS census_profile_nov_prairies_total_dauid_idx ON census_profile.census_profile_nov_prairies_total ("DAUID");

CREATE INDEX IF NOT EXISTS census_profile_nov_prairies_total2_idx ON census_profile.census_profile_nov_prairies_total2 using GIST(geom);
CREATE INDEX IF NOT EXISTS census_profile_nov_prairies_total2_dauid_idx ON census_profile.census_profile_nov_prairies_total2 ("DAUID");