...
(
SELECT * 
FROM CROSSTAB('SELECT "DGUID","CHARACTERISTIC_ID","C2_COUNT_MEN+" FROM census_profile.census_profile_sept_{P/T} 
...
DROP TABLE IF EXISTS census_profile.census_profile_sept_{P/T}_total_men;
CREATE TABLE census_profile.census_profile_sept_{P/T}_total_men AS
(
SELECT
b."DAUID",
a.*,
