...
(
SELECT * 
FROM CROSSTAB('SELECT "DGUID","CHARACTERISTIC_ID","C3_COUNT_WOMEN+" FROM census_profile.census_profile_nov_bc 
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_bc_women;
CREATE TABLE census_profile.census_profile_nov_bc_women AS
(
SELECT
b."DAUID",
a.*,
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_bc_women2;
CREATE TABLE census_profile.census_profile_nov_bc_women2 AS
(
SELECT
b."DAUID",
a.*,
...
-- create indexes
CREATE INDEX IF NOT EXISTS census_profile_nov_bc_women_idx ON census_profile.census_profile_nov_bc_women using GIST(geom);
CREATE INDEX IF NOT EXISTS census_profile_nov_bc_women_dauid_idx ON census_profile.census_profile_nov_bc_women ("DAUID");

CREATE INDEX IF NOT EXISTS census_profile_nov_bc_women2_idx ON census_profile.census_profile_nov_bc_women2 using GIST(geom);
CREATE INDEX IF NOT EXISTS census_profile_nov_bc_women2_dauid_idx ON census_profile.census_profile_nov_bc_women2 ("DAUID");