...
(
SELECT * 
FROM CROSSTAB('SELECT "DGUID","CHARACTERISTIC_ID","C1_COUNT_TOTAL" FROM census_profile.census_profile_nov_ontario 
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_ontario_total;
CREATE TABLE census_profile.census_profile_nov_ontario_total AS
(
SELECT
b."DAUID",
a.*,
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_ontario_total2;
CREATE TABLE census_profile.census_profile_nov_ontario_total2 AS
(
SELECT
b."DAUID",
a.*,
...
-- create indexes
CREATE INDEX IF NOT EXISTS census_profile_nov_ontario_total_idx ON census_profile.census_profile_nov_ontario_total using GIST(geom);
CREATE INDEX IF NOT EXISTS census_profile_nov_ontario_total_dauid_idx ON census_profile.census_profile_nov_ontario_total ("DAUID");

CREATE INDEX IF NOT EXISTS census_profile_nov_ontario_total2_idx ON census_profile.census_profile_nov_ontario_total2 using GIST(geom);
CREATE INDEX IF NOT EXISTS census_profile_nov_ontario_total2_dauid_idx ON census_profile.census_profile_nov_ontario_total2 ("DAUID");