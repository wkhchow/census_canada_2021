...
(
SELECT * 
FROM CROSSTAB('SELECT "DGUID","CHARACTERISTIC_ID","C3_COUNT_WOMEN+" FROM census_profile.census_profile_sept_{P/T} 
...
DROP TABLE IF EXISTS census_profile.census_profile_sept_{P/T}_total_women;
CREATE TABLE census_profile.census_profile_sept_{P/T}_total_women AS
(
SELECT
b."DAUID",
a.*,
