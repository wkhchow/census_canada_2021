...
(
SELECT * 
FROM CROSSTAB('SELECT "DGUID","CHARACTERISTIC_ID","C2_COUNT_MEN+" FROM census_profile.census_profile_nov_atlantic 
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_atlantic_men;
CREATE TABLE census_profile.census_profile_nov_atlantic_men AS
(
SELECT
b."DAUID",
a.*,
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_atlantic_men2;
CREATE TABLE census_profile.census_profile_nov_atlantic_men2 AS
(
SELECT
b."DAUID",
a.*,
...
-- create indexes
CREATE INDEX IF NOT EXISTS census_profile_nov_atlantic_men_idx ON census_profile.census_profile_nov_atlantic_men using GIST(geom);
CREATE INDEX IF NOT EXISTS census_profile_nov_atlantic_men_dauid_idx ON census_profile.census_profile_nov_atlantic_men ("DAUID");

CREATE INDEX IF NOT EXISTS census_profile_nov_atlantic_men2_idx ON census_profile.census_profile_nov_atlantic_men2 using GIST(geom);
CREATE INDEX IF NOT EXISTS census_profile_nov_atlantic_men2_dauid_idx ON census_profile.census_profile_nov_atlantic_men2 ("DAUID");