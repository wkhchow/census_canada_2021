...
(
SELECT * 
FROM CROSSTAB('SELECT "DGUID","CHARACTERISTIC_ID","C3_COUNT_WOMEN+" FROM census_profile.census_profile_nov_prairies 
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_prairies_women;
CREATE TABLE census_profile.census_profile_nov_prairies_women AS
(
SELECT
b."DAUID",
a.*,
...
DROP TABLE IF EXISTS census_profile.census_profile_nov_prairies_women2;
CREATE TABLE census_profile.census_profile_nov_prairies_women2 AS
(
SELECT
b."DAUID",
a.*,
