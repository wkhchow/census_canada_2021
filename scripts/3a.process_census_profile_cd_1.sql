DROP TABLE IF EXISTS census_profile.census_profile_cd_sorted;
CREATE TABLE census_profile.census_profile_cd_sorted AS
(
SELECT 
zzz."CDUID" AS "cduid",
a.cdname,
...
LEFT JOIN boundaries."Geometry_CDUID" zzz on a."DGUID" = zzz."DGUID"
);
